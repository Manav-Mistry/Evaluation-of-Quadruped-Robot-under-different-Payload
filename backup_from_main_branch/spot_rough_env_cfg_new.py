...
class SpotRewardsCfg:
    ...
    air_time = RewardTermCfg(
        func=spot_mdp.adaptive_air_time_reward,
        weight=5.0,
        params={
            "min_mode_time": 0.25,  # Quick steps for flat/smooth terrain
            "max_mode_time": 0.35,  # Stable steps for stairs/rough terrain
            "velocity_threshold": 0.75,
            "roughness_threshold": 0.005,  # Terrain variance threshold to switch modes
            "asset_cfg": SceneEntityCfg("robot"),
    ...
    gait = RewardTermCfg(
        ...
        weight=8.0,  # Increased for better gait coordination on rough terrain
        params={
            "std": 0.1,
            "max_err": 0.2,
